...
def contextual_action_bar(
    ...
    actions_by_page = {
        ...
        BrowserPage.TASK_OUTPUT: (
            ...
            "problems 问题列表",
            "view problem 查看选中问题",
            "view problem diff 查看 diff",
            "copy problem diff 复制 diff",
            "save problem 保存问题",
            "save problem diff 保存 diff",
            "copy context 复制选中问题",
            "save context 保存选中问题",
            "copy task tail 复制尾部",
            "copy task match 复制匹配",
            "copy task 复制任务",
            "save task 保存任务",
            "stop",
            "rerun",
    ...
    topics = {
        ...
        BrowserPage.FILE_DETAIL: (
            ...
            (
                ...
                "next problem / prev problem：跳到当前文件的下一个或上一个任务问题",
                ...
                "copy problem context / save problem context：复制或保存当前源码行、diff，以及命中的任务问题",
        ...
        BrowserPage.TASK_OUTPUT: (
            ...
            (
                ...
                "copy problem diff / save problem diff [PATH]：复制或保存当前问题对应的文件 diff",
                ...
                "copy task match / save task match [PATH]：复制或保存当前 find 匹配附近输出",
                "save problem [PATH]：保存当前问题，默认写到 .cr/handoff/task-problem.md",
        ...
        BrowserPage.TASK_PROBLEMS: (
            ...
            (
                ...
                "view problem diff：打开选中问题对应的文件 diff",
                ...
                "copy problem diff / save problem diff [PATH]：复制或保存当前问题对应的文件 diff",
                "copy problem / save problem：复制或保存当前问题",
                "copy problems：复制当前列表",
        ...
        BrowserPage.SOURCE_FILE: (
            ...
            (
                ...
                "copy problem / save problem：复制或保存当前源码行对应的任务问题",
                "copy problem diff / save problem diff [PATH]：复制或保存当前问题对应的文件 diff",
