...
class CliTests(unittest.TestCase):
    ...
    def test_task_problems_sorts_by_severity_preserving_bucket_order(self):
        problems = [
    ...
    def test_file_detail_navigation_resolves_current_changed_row(self):
        lines = [
            "File 1/1  src/Sample.ts",
            "  @@ -1,2 +10,2 @@",
            "     1   10 | context",
    ...
    def test_handoff_module_saves_task_problem_default_and_requested_paths(self):
        with tempfile.TemporaryDirectory() as tmp:
            repo = Path(tmp)
    ...
    def test_page_content_contextual_action_bar_matches_current_page(self):
        ...
        self.assertIn("next file 下个文件", task_problems)
        self.assertIn("prev file 上个文件", task_problems)
    ...
    def test_page_content_task_problems_screen_lines_render_sort_state(self):
        problems = [
            task_problems.TaskProblem(
                path="src/Foo.ets",
                line=12,
    ...
    def test_page_content_task_problems_screen_lines_render_grouped_by_file(self):
        problems = [
            task_problems.TaskProblem(
                path="src/Foo.ets",
                line=12,
